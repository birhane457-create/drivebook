...
**Tier required:** STUDIO or PREMIUM  
...
STUDIO and PREMIUM tier providers can use a custom domain (e.g. `book.myschool.com.au`) instead of the default `[slug].drivebook.com.au` subdomain.
...
- Custom domains are available on STUDIO and PREMIUM tiers
