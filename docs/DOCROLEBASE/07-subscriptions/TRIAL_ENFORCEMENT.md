...
| **PREMIUM** | 30 | $199 | $1,990 | 1 (multi-provider: BUSINESS tier, Coming Soon) | ✅ | ✅ | 10 |
...
- Check: `subscriptionTier != STUDIO|PREMIUM` → 403 "Requires Studio+ plan"
...
model Subscription {
  ...
  tier                 String        // BASIC | PRO | STUDIO | PREMIUM
