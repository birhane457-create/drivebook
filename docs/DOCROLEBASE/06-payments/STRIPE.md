...
| `STRIPE_PREMIUM_MONTHLY_PRICE_ID` | Stripe Price ID for PREMIUM monthly | Set in .env — create live ID in Stripe dashboard |
| `STRIPE_PREMIUM_ANNUAL_PRICE_ID` | Stripe Price ID for PREMIUM annual | Set in .env — create live ID in Stripe dashboard |
