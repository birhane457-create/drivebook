...
Before making any code or doc change, read:
- `.kiro/steering/platform-model.md` — core mental model: tiers vs account types vs payment modes, string collision table, multi-vertical rules, phase 2 block list
- `.kiro/steering/doc-sync.md` — doc update rules: every code change requires a doc update in the same session

These are always loaded automatically by the Kiro AI agent.
...
### 04-business — Multi-provider / Driving school ⚠️ Coming Soon (BUSINESS tier not yet implemented)
| File | Covers |
|------|--------|
...
| File | Covers |
|------|--------|
| [TIERS.md](../07-subscriptions/TIERS.md) | BASIC / PRO / STUDIO / PREMIUM feature comparison (BUSINESS = Coming Soon) |
...
- **Commission:** BASIC 15% / PRO 12% / STUDIO 11% / PREMIUM 10% (DB-configurable via `/admin/pricing`)
- **Trial:** BASIC/PRO/STUDIO 14 days, PREMIUM 30 days
