...
**Auth required:** INSTRUCTOR role (PRO, STUDIO, or PREMIUM tier for full access)  
...
|---------|-------|--------------|
| Brand logo | `brandLogo` (Cloudinary URL) | PRO / STUDIO / PREMIUM |
...
| Show branding on booking page | `showBrandingOnBookingPage` | PRO / STUDIO / PREMIUM |

---

## Tier Gate

BASIC tier instructors see an upgrade prompt for logo upload and the `showBrandingOnBookingPage` toggle. Color pickers and slug are available to all tiers. PRO, STUDIO, and PREMIUM tiers unlock full branding.
...
- `docs/04-business/DOMAIN_SETUP.md` â€” Custom domain for STUDIO/PREMIUM tier
