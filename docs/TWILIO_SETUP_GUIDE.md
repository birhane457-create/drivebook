...
- Twilio Account
- Twilio Phone Number: (your AU number from Twilio dashboard â€” format: +61XXXXXXXXX)
...
### Local Testing
- âœ… `SKIP_TWILIO_VALIDATION=true` is OK
- âœ… ngrok exposes your local server temporarily
- âœ… Use test Twilio credentials if available

### Production
- âŒ Never skip Twilio validation
- âŒ Never commit `.env` with real credentials
