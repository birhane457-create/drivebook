...
| INT-M-PKG-01 | client/packages/mobile IDOR + hardcoded price | MEDIUM | CONFIRMED | VERIFIED — packageId from request body used as providerId with no validation; price hardcoded $500; booking immediately CONFIRMED | NOT-STARTED | PENDING | ⚠️ OPEN | Discovered during DOC-EXP-01 remediation | INT-M-PKG-01 |
