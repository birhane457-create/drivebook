...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-primary/5 via-white to-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-4 text-sm text-gray-400">No credit card required · Setup in under 5 minutes</p>
        </div>
      ...
      <section id="features" className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Everything Your Business Needs</h2>
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">One platform, every workflow — from receiving dock to customer delivery.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map(f => {
              const FI = f.icon;
              return (
                <div key={f.label} className="bg-white p-6 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow group">
      ...
      <section id="industries" className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Built for Your Industry</h2>
            <p className="text-lg text-gray-500">Purpose-built configurations for six major verticals.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {INDUSTRIES.map(ind => {
              const II = ind.icon;
              return (
                <div key={ind.name} className="flex items-center gap-4 p-5 rounded-2xl border border-gray-100 hover:border-primary/30 hover:bg-primary/5 transition-all cursor-pointer group">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Trusted by Operations Teams</h2>
          </div>
      ...
      <section id="pricing" className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-500">Scale from startup to enterprise without re-platforming.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={plan.name} className={`p-6 rounded-2xl border-2 ${plan.popular ? 'border-primary shadow-lg shadow-primary/10' : 'border-gray-100'} relative`}>
      ...
      <section className="py-20 px-6 bg-primary text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-black mb-4">Ready to Modernise Your Operations?</h2>
          <p className="text-primary-foreground/80 text-lg mb-8">Join hundreds of operations teams already running on WMS Pro.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register">
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm">© 2026 WMS Pro. All rights reserved.</p>
