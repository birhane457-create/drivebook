...
# AI Admin Operations Copilot — Feature Roadmap

> **Note:** This is a feature roadmap, not a standing instruction. It is loaded manually when working on admin copilot features. See `.kiro/steering/platform-model.md` for standing agent instructions.
