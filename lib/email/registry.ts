...
export const EMAIL_EVENTS = {
  ...
  APPOINTMENT_REMINDER:    { id: 'booking.reminder',                sender: 'bookings',     category: 'booking'    },
  ...
  INSTRUCTOR_REGISTRATION: { id: 'onboarding.provider-register',  sender: 'team',         category: 'onboarding' },
  ...
  // ── Admin / support ───────────────────────────────────────────────────────
  INSTRUCTOR_APPROVED:     { id: 'admin.provider-approved',       sender: 'support',      category: 'admin'      },
  INSTRUCTOR_REJECTED:     { id: 'admin.provider-rejected',       sender: 'support',      category: 'admin'      },
  INSTRUCTOR_SUSPENDED:    { id: 'admin.provider-suspended',      sender: 'support',      category: 'admin'      },
