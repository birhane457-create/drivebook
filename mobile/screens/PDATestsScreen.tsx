                  ...
                  <View style={styles.testHeaderLeft}>
                    ...
                    <View style={styles.testHeaderInfo}>
                      <View style={styles.testHeaderRow}>
                        <Text style={styles.customerName}>{test.customer.name}</Text>
                ...
                {isExpanded && (
                  <View style={styles.testDetails}>
                    ...
                    <View style={styles.detailSection}>
                      ...
                      <Text style={styles.detailText}>{test.customer.name}</Text>
                      <Text style={styles.detailText}>📞 {test.customer.phone}</Text>
                      <Text style={styles.detailText}>✉️ {test.customer.email}</Text>
                    </View>
