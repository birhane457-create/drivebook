...
export default function BookingsScreen({ onSelectBooking, onNewBooking }: { onSelectBooking: (id: string) => void; onNewBooking: () => void }) {
  ...
  const getFilteredBookings = () => {
    ...
    return bookings.filter(booking => {
      ...
      if (!booking || !booking.customer || !booking.startTime) {
          ...
          <View style={styles.headerLeft}>
            ...
            <View style={styles.headerInfo}>
              <View style={styles.nameRow}>
                <Text style={styles.customerName} numberOfLines={1}>{item.customer?.name || 'Unknown'}</Text>
          ...
          <View style={styles.expandedContent}>
            <View style={styles.detailsGrid}>
              ...
              <View style={styles.detailSection}>
                ...
                <View style={styles.detailItem}>
                  <Text style={styles.detailIcon}>📞</Text>
                  <Text style={styles.detailValue}>{item.customer?.phone || 'N/A'}</Text>
                </View>
                <View style={styles.detailItem}>
                  <Text style={styles.detailIcon}>✉️</Text>
                  <Text style={styles.detailValue}>{item.customer?.email || 'N/A'}</Text>
                </View>
              </View>
