...
export default function PublicBookingScreen({ onNavigate }: { onNavigate: (screen: string) => void }) {
  ...
  const [customerEmail, setClientEmail] = useState('');
  const [customerPhone, setClientPhone] = useState('');
  ...
  const handleSubmitBooking = async () => {
    // Validation
    if (!customerName || !customerEmail || !clientPhone || !date || !time || !pickupAddress) {
