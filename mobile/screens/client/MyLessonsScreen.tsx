  ...
  const renderBookingCard = (booking: Booking) => (
    ...
    >
      <View style={styles.bookingHeader}>
        <View>
          <Text style={styles.instructorName}>{booking.providerName}</Text>
    ...
    <View style={styles.container}>
      ...
      {rescheduleModal?.booking && (
        <RescheduleModal
          ...
          instructorName={rescheduleModal.booking.providerName}
      ...
      {cancelDialog?.booking && (
        <CancelDialog
          ...
          instructorName={cancelDialog.booking.providerName}
      ...
      {reviewModal?.booking && (
        <ReviewModal
          ...
          instructorName={reviewModal.booking.providerName}
          onSuccess={fetchBookings}
        />
      )}
    </View>
