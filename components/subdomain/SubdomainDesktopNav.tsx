  ...
  return (
    <div className="hidden md:flex items-center gap-1">
      ...
      <button
        ...
        className="p-1.5 text-muted-foreground/60 hover:text-gray-800 hover:bg-gray-50 rounded-lg transition-colors"
      >
        {copied ? <Check className="h-4 w-4 text-green-600" /> : <Share2 className="h-4 w-4" />}
      </button>
      <button
        onClick={() => scrollTo('booking-form')}
        className="ml-1 px-4 py-1.5 rounded-lg text-foreground text-sm font-semibold transition-opacity hover:opacity-90"
