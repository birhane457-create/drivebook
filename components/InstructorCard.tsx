      ...
      <div className="bg-white rounded-lg shadow hover:shadow-lg transition p-4">
        ...
        <div className="flex items-center justify-between mb-3 pb-3 border-b">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground/60">/hour</span>
          </div>
        ...
        <div className="flex gap-2">
          ...
          <Link
            href={bookingUrl}
            className="flex-1 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90 font-medium text-sm text-center"
          >
            Book Now
          </Link>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          <div className="flex items-center gap-4 mb-6">
              ...
              {instructor.bio ? (
                ...
                <div className="mb-6 text-muted-foreground/60 italic">
              ...
              <Link
                href={bookingUrl}
                className="block w-full py-3 bg-primary text-foreground rounded-lg hover:bg-primary/90 font-semibold text-center"
              >
