...
function CardFront({ data }: { data: CardData }) {
  ...
  return (
    <div
      ...
      className="relative bg-card rounded-xl overflow-hidden shadow-xl flex flex-col select-none"
    >
      {/* Top accent bar */}
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex flex-col justify-between p-4 flex-1 min-w-0">
          {/* Brand */}
          <div>
            <p className="text-[9px] font-bold tracking-[0.2em] text-primary uppercase mb-0.5">
              DriveBook
            </p>
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <span className="text-[9px] font-bold text-muted-foreground/60 uppercase tracking-wide w-5 shrink-0">Ph</span>
            ...
            {data.suburbs && (
              <div className="flex items-start gap-1.5">
                <span className="text-[9px] font-bold text-muted-foreground/60 uppercase tracking-wide w-5 shrink-0 mt-0.5">Loc</span>
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[9px] font-bold text-muted-foreground/60 uppercase tracking-wide w-5 shrink-0">Car</span>
        ...
        <div className="flex flex-col items-center justify-center px-4 gap-1.5 shrink-0">
          ...
          <p className="text-[8px] text-muted-foreground/60 text-center">Scan to book</p>
        </div>
      </div>
    </div>
  )
    ...
    >
      ...
      <div className="flex flex-col flex-1 px-4 py-3 gap-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <p className="text-[8px] text-muted-foreground">Book next lesson online</p>
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-[52px_1fr_52px] gap-x-1 mb-0.5">
            <p className="text-[8px] font-semibold text-muted-foreground/60 uppercase tracking-wide">Date</p>
            <p className="text-[8px] font-semibold text-muted-foreground/60 uppercase tracking-wide">Focus / Skill</p>
            <p className="text-[8px] font-semibold text-muted-foreground/60 uppercase tracking-wide text-right">Signed</p>
          </div>
