...
export default function ImageCarousel({
  ...
  if (slides.length === 0) {
    return <div className="text-center text-muted-foreground/60 py-12">No slides available</div>
  }
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto" inert={true} aria-hidden="true">
      ...
      <div className="relative aspect-[3/2] bg-gray-100 rounded-2xl overflow-hidden shadow-2xl">
        ...
        {/* Auto-play Indicator */}
        {isAutoPlaying && (
          <div className="absolute top-4 right-4 bg-black/50 text-foreground px-3 py-1 rounded-full text-sm flex items-center gap-2">
