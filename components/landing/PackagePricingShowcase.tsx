...
export default function PackagePricingShowcase() {
  ...
  const slides = [
    {
      ...
      content: (
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto border-2 border-gray-200">
          ...
          <button className="w-full bg-purple-600 text-foreground py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors">
            Book Single Lesson
          </button>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto border-2 border-blue-400">
          <div className="absolute top-4 right-4 bg-blue-500 text-foreground px-3 py-1 rounded-full text-sm font-semibold">
            SAVE 5%
          </div>
          <div className="text-center mb-6">
            <div className="text-muted-foreground line-through text-lg">$225</div>
          ...
          <button className="w-full bg-primary text-foreground py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors">
            Buy 5-Hour Package
          </button>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto border-2 border-green-400">
          <div className="absolute top-4 right-4 bg-green-500 text-foreground px-3 py-1 rounded-full text-sm font-semibold">
            SAVE 8%
          </div>
          <div className="text-center mb-6">
            <div className="text-muted-foreground line-through text-lg">$450</div>
          ...
          <button className="w-full bg-emerald-600 text-foreground py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors">
            Buy 10-Hour Package
          </button>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto border-2 border-amber-400">
          <div className="absolute top-4 right-4 bg-amber-500 text-foreground px-3 py-1 rounded-full text-sm font-semibold">
            SAVE 12%
          </div>
          <div className="text-center mb-6">
            <div className="text-muted-foreground line-through text-lg">$900</div>
          ...
          <button className="w-full bg-amber-600 text-foreground py-3 rounded-lg font-semibold hover:bg-amber-700 transition-colors">
            Buy 20-Hour Package
          </button>
        </div>
      )
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 shadow-lg" inert={true} aria-hidden="true">
      ...
      {/* Slide Counter */}
      <div className="text-center mt-4 text-sm text-muted-foreground/60">
