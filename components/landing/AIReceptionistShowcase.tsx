  ...
  return (
    <div className="w-full max-w-7xl mx-auto" inert={true} aria-hidden="true">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
        <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-foreground p-6">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 text-center border-2 border-purple-200">
          ...
          {VOICE_NUMBER ? (
            <a
              ...
              className="inline-block bg-purple-600 text-foreground px-8 py-4 rounded-xl no-underline font-bold text-2xl hover:bg-purple-700 transition-all shadow-lg mb-4"
            >
              {VOICE_NUMBER}
            </a>
          ) : (
          ...
          <div className="grid gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-5 h-5 bg-purple-600 rounded-full flex items-center justify-center">
                <span className="text-xs text-foreground font-bold">S</span>
              </div>
              <div>
