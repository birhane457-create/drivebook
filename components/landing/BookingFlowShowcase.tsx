  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-0" inert={true} aria-hidden="true">
      ...
      <div className="bg-white rounded-xl md:rounded-2xl shadow-lg md:shadow-2xl overflow-hidden border border-gray-200" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-foreground p-4 md:p-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 md:p-6">
        <div className="flex flex-col gap-3 md:gap-4">
          <div className="flex-1 relative">
            <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 md:h-5 w-4 md:w-5 text-muted-foreground" />
            <input
              type="text"
          ...
          <button className="bg-primary text-foreground px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold hover:bg-primary/90 flex items-center justify-center gap-2 w-full md:w-auto">
          ...
          <div key={idx} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="h-32 md:h-48 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
              <div className="w-16 md:w-24 h-16 md:h-24 bg-white rounded-full flex items-center justify-center">
                <span className="text-2xl md:text-4xl font-bold text-muted-foreground">{instructor.name.charAt(0)}</span>
              </div>
            </div>
            ...
            <div className="p-3 md:p-4">
              ...
              <button className="w-full bg-primary text-foreground py-2 md:py-2.5 rounded-lg font-semibold text-sm md:text-base hover:bg-primary/90 transition-colors">
                Book Now
              </button>
            </div>
          </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 md:p-6">
          ...
          <div className="text-center mb-3 md:mb-4">
            <div className="w-24 md:w-32 h-24 md:h-32 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full mx-auto flex items-center justify-center mb-2 md:mb-3">
              <span className="text-2xl md:text-4xl font-bold text-muted-foreground">S</span>
            </div>
          ...
          <div className="space-y-2 md:space-y-3 mb-3 md:mb-4">
            <div className="flex items-center gap-2">
              <DollarSign className="h-4 md:h-5 w-4 md:w-5 text-muted-foreground" />
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 md:gap-2">
              {['6051', '6052', '6053'].map((code: any) => (
                <span key={code} className="px-2.5 py-1 bg-green-500 text-foreground rounded-full text-xs md:text-sm">
                  {code}
                </span>
              ))}
            </div>
      ...
      <div className="lg:col-span-2">
        <div className="bg-white rounded-lg shadow-lg p-4 md:p-6">
          ...
          <button className="w-full bg-primary text-foreground py-3 md:py-4 rounded-lg font-bold text-base md:text-lg hover:bg-primary/90 transition-colors flex items-center justify-center gap-2">
            Continue to Payment
    ...
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg md:shadow-xl p-4 md:p-8">
        ...
        <div className="flex gap-2 mb-4 md:mb-6">
          <button className="flex-1 py-2 px-4 bg-primary text-foreground rounded-lg font-semibold text-sm md:text-base">
            Credit Card
          </button>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1">
                ...
                <div className="w-8 h-5 bg-destructive rounded"></div>
              </div>
            </div>
          </div>
        ...
        <button className="w-full bg-primary text-foreground py-3 md:py-4 rounded-lg font-bold text-base md:text-lg hover:bg-primary/90 transition-colors mt-4 md:mt-6">
          Pay $414 Now
        </button>
      </div>
    </div>
    ...
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg md:shadow-xl p-4 md:p-8 text-center">
        ...
        <div className="flex flex-col gap-3">
          <button className="w-full bg-primary text-foreground py-2.5 md:py-3 rounded-lg font-semibold text-sm md:text-base hover:bg-primary/90 transition-colors">
            Go to Dashboard
          </button>
