      ...
      <div className="flex space-x-1">
        {[1, 2, 3, 4, 5].map((star) => (
          ...
          >
            <svg
              className={`w-8 h-8 ${
                star <= value ? 'text-yellow-400' : 'text-foreground'
              }`}
              fill="currentColor"
              viewBox="0 0 20 20"
            >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-primary text-foreground py-2 px-4 rounded-md hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
      >
