...
export default function MultiStepBookingLayout({ currentStep, children }: MultiStepBookingLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-32 lg:pb-12">
      ...
      <div className="relative z-30 mx-2 sm:mx-6 my-4 rounded-2xl border-2 border-slate-400 bg-card shadow-[0_6px_0_0_#475569,0_15px_25px_0_rgba(0,0,0,0.6)]">
      ...
      <div className="max-w-7xl mx-2 sm:mx-4 px-2 sm:px-4 py-4 sm:py-4">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-card rounded-2xl shadow-2xl p-3 sm:p-6 border-2 border-border shadow-[0_8px_0_0_#1e293b,0_25px_35px_0_rgba(0,0,0,0.5)]">
              {children}
            </div>
          </div>
        </div>
