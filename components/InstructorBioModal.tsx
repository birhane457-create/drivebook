...
export default function InstructorBioModal({ provider: instructor, onClose, onSelect }: InstructorBioModalProps) {
  return (
      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky bottom-0 bg-white border-t px-6 py-4 flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-6 py-3 text-foreground bg-primary rounded-lg hover:bg-primary/90 transition-colors font-medium"
          >
            Select Instructor
          </button>
        </div>
