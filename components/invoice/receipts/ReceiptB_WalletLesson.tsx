...
export default function ReceiptB_WalletLesson({ isDemo }: Props) {
  return (
    ...
    >
      ...
      <div>
        <p className="text-xs text-muted-foreground/60 uppercase tracking-wide mb-2">Lesson Booked</p>
        <p className="font-semibold text-foreground">Wednesday, 24 July 2026 at 10:00 AM</p>
        <p className="text-sm text-muted-foreground mt-0.5">Duration: 2 hours · Instructor: James Nguyen</p>
      </div>

      <div>
        <p className="text-xs text-muted-foreground/60 uppercase tracking-wide mb-2">Payment</p>
        <LineItems
          lines={[
