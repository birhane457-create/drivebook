  ...
  return (
    ...
    >
      <ReceiptMeta rows={[
        ...
        { label: 'Paid by', value: d.customerName },
        { label: 'Email', value: d.customerEmail },
      ]} />

      <div>
        <p className="text-xs text-muted-foreground/60 uppercase tracking-wide mb-2">What You Purchased</p>
        <p className="font-semibold text-foreground">{d.packageHours}-Hour Driving Lesson Package</p>
        <p className="text-sm text-muted-foreground mt-0.5">with {d.instructorName} · {d.instructorLocation}</p>
        ...
        <p className="text-xs text-muted-foreground">Duration: {d.firstLessonDuration} hours</p>
      </div>

      <div>
        <p className="text-xs text-muted-foreground/60 uppercase tracking-wide mb-2">Payment Breakdown</p>
        <LineItems
          lines={[
        ...
        />
        <p className="text-xs text-muted-foreground/60 mt-2">Payment method: {d.paymentMethod}</p>
