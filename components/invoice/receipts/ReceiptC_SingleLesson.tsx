  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="font-semibold text-foreground">Wednesday, 24 July 2026 at 09:00 AM</p>
        <p className="text-sm text-muted-foreground mt-0.5">Duration: 2 hours · Instructor: James Nguyen</p>
      ...
      <div>
        ...
        />
        <p className="text-xs text-muted-foreground/60 mt-2">Payment method: Visa •••• 4242</p>
