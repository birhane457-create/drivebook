...
export default function ReceiptE_Cancellation({ isDemo, variant = 'full' }: Props) {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-xs text-muted-foreground/60 uppercase tracking-wide mb-2">Cancelled Lesson</p>
        <p className="font-semibold text-foreground">Wednesday, 24 July 2026 at 09:00 AM</p>
        <p className="text-sm text-muted-foreground mt-0.5">Instructor: James Nguyen</p>
      </div>

      <div>
        <p className="text-xs text-muted-foreground/60 uppercase tracking-wide mb-2">Refund Summary</p>
        <LineItems
          lines={[
