...
export default function ClientMobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-xl border-t border-border shadow-2xl lg:hidden z-50">
            ...
            >
              <div className={`relative flex items-center justify-center ${active ? 'scale-105' : ''} transition-transform`}>
                ...
                {item.badge != null && item.badge > 0 && (
                  <span className="absolute -top-1 -right-1 h-4 w-4 bg-red-500 text-foreground text-[10px] rounded-full flex items-center justify-center font-bold leading-none">
