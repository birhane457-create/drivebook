        ...
        <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-4 space-y-3">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="flex-1 py-2 px-4 bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-300 text-foreground font-semibold rounded-lg transition-colors"
            >
        ...
        <>
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg font-semibold text-foreground transition-colors ${
              type === 'check-in'
                ? 'bg-emerald-600 hover:bg-green-700 disabled:bg-green-300'
                : 'bg-primary hover:bg-primary/90 disabled:bg-blue-300'
            }`}
          >
            {loading ? (
