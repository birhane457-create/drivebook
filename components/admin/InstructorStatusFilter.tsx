  ...
  return (
    <div className="mb-6">
      ...
      <div className="sm:hidden">
        <select
          className="block w-full rounded-md border-border focus:border-blue-500 focus:ring-blue-500"
          value={currentStatus}
          ...
          {TABS.map((t) => (
            ...
            >
              ...
              {t.value === 'pending' && pendingCount > 0 && (
                <span className="ml-1.5 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold rounded-full bg-amber-500 text-foreground min-w-[1.25rem]">
                  {pendingCount}
                </span>
              )}
            </a>
