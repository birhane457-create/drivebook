  ...
  return (
    <>
      ...
      <div className="cursor-pointer group" onClick={() => setIsOpen(true)}>
        ...
        />
        <p className="text-xs text-muted-foreground/60 mt-1 text-center">Click to enlarge</p>
      </div>
        ...
        >
          <div className="relative max-w-4xl w-full">
            <button
              ...
              className="absolute -top-10 right-0 text-foreground hover:text-foreground text-xl font-bold"
            >
              ✕ Close
            </button>
            <Image
