...
export default function ReadOnlyBanner({ reason, status }: ReadOnlyBannerProps) {
  ...
  return (
    <div className="sticky top-16 z-40 flex items-center gap-3 rounded-2xl border border-amber-500/30 bg-card/95 px-4 py-3 shadow-lg shadow-amber-600/10 backdrop-blur-xl">
