        ...
        <div className="flex flex-wrap gap-2">
          {value.map((s, i) => (
            ...
            >
              ...
              {s.suburb}
              <span className="text-primary/60">{s.state} {s.postcode}</span>
              <button
                type="button"
        ...
        <div ref={containerRef} className="relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-background/60 border border-border rounded-lg pl-9 pr-4 py-2.5 text-sm text-foreground placeholder-slate-500 focus:outline-none focus:border-sky-500/50 transition-colors"
              autoComplete="off"
              autoCorrect="off"
              spellCheck={false}
            />
