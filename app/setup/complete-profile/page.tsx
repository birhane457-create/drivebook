...
export default function CompleteProfilePage() {
  ...
  return (
    <div className="light min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            {[1, 2, 3, 4].map((s: any) => (
              <div key={s} className="flex items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  step >= s ? 'bg-primary text-foreground' : 'bg-gray-200 text-muted-foreground/60'
                }`}>
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                />
                <p className="text-sm text-muted-foreground/60 mt-1">{formData.bio?.length || 0} characters</p>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="text-center">
                {formData.profileImage ? (
                  <div className="relative inline-block">
                    ...
                    <button
                      ...
                      className="absolute top-0 right-0 bg-red-500 text-foreground rounded-full p-2 hover:bg-destructive"
                    >
                      ×
                    </button>
                  </div>
                ...
                <label className="mt-4 inline-block cursor-pointer bg-primary text-foreground px-6 py-3 rounded-lg hover:bg-primary/90">
                ...
                <p className="text-sm text-muted-foreground/60 mt-2">Professional photo helps build trust</p>
              </div>
            </div>
          )}
                ...
                {formData.carImage ? (
                  <div className="relative inline-block">
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 bg-red-500 text-foreground rounded-full p-2 hover:bg-destructive"
                    >
                      ×
                    </button>
                  </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                />
                <p className="text-sm text-muted-foreground/60 mt-1">Your professional instructor license</p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-sm text-muted-foreground/60 mt-1">Vehicle insurance policy number</p>
              </div>
          ...
          <div className="flex justify-between mt-8 pt-6 border-t">
            ...
            {step < 4 ? (
              <button
                onClick={() => setStep(step + 1)}
                className="ml-auto px-6 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90"
              >
                Next
              </button>
            ) : (
              <button
                ...
                disabled={loading}
                className="ml-auto px-6 py-2 bg-emerald-600 text-foreground rounded-lg hover:bg-green-700 disabled:opacity-50"
              >
          ...
          <div className="text-center mt-4">
            <button
              ...
              className="text-sm text-muted-foreground/60 hover:text-gray-700"
            >
