...
export default function SetupPage() {
  return (
    <div className="light min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 bg-primary text-foreground rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div>
                ...
                <Link 
                  href="/register"
                  className="inline-block bg-primary text-foreground px-6 py-2 rounded-lg hover:bg-primary/90"
                >
                  Register Now
                </Link>
              </div>
