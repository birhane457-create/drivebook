    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <div className="mt-4 bg-yellow-900/20 border border-yellow-700/50 rounded-md p-4">
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-3 py-2 border border-slate-600 placeholder-slate-500 text-slate-100 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-3 py-2 border border-slate-600 placeholder-slate-500 text-slate-100 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm bg-slate-800"
        ...
        <div className="mt-6 bg-blue-900/20 border border-blue-700/50 rounded-md p-4">
          <h3 className="text-sm font-medium text-blue-200 mb-2">What's the difference?</h3>
