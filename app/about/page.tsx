...
export default function AboutPage() {
  return (
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border py-4 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <Link href="/book" className="text-foreground/70 hover:text-foreground font-medium px-3 py-2 rounded-lg hover:bg-secondary transition-colors hidden md:block no-underline">Find Instructor</Link>
            <Link href="/login" className="text-foreground/70 hover:text-foreground font-medium px-3 py-2 rounded-lg hover:bg-secondary transition-colors no-underline">Login</Link>
            <Link href="/register" className="bg-gradient-to-r from-pink-500 to-violet-500 text-foreground px-5 py-2 rounded-xl font-bold hover:from-pink-400 hover:to-violet-400 transition-all no-underline">Sign Up</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 space-y-20">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl bg-secondary/50 border border-border hover:border-violet-500/40 transition-all">
              ...
              <p className="text-white/70">We match learner drivers with local, verified instructors based on location, availability, and price — no phone tag required.</p>
            </div>
            <div className="text-center p-6 rounded-xl bg-secondary/50 border border-border hover:border-emerald-500/40 transition-all">
              <div className="w-14 h-14 bg-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Shield className="h-7 w-7 text-emerald-400" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Verify Every Instructor</h3>
              <p className="text-white/70">Every instructor on DriveBook is background-checked, licensed, and reviewed by real students before they can accept bookings.</p>
            </div>
            <div className="text-center p-6 rounded-xl bg-secondary/50 border border-border hover:border-cyan-500/40 transition-all">
              ...
              <p className="text-white/70">Book a lesson in seconds. See real-time availability, pay securely, and get instant SMS confirmation — all from your phone.</p>
            </div>
          </div>
        </section>

        {/* Values */}
        <section className="bg-secondary/50 rounded-2xl border border-border p-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Every instructor is verified. Every payment is protected. Every learner deserves to feel safe.</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Clear pricing, clear cancellation policies, clear refunds. No hidden fees, no surprises.</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">We hold instructors to a high standard. Real reviews from real students keep the bar high.</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Instructors get paid fairly and on time. Learners get honest pricing. The platform earns only when both parties succeed.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* Footer */}
      <footer className="bg-card/50 backdrop-blur border-t border-border text-white py-10 px-4 mt-8">
        ...
        <div className="border-t border-border pt-6 text-center text-sm text-white/50">
