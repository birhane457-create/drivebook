  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        ...
        className="w-full bg-primary text-foreground py-3 px-4 rounded-lg hover:bg-primary/90 disabled:bg-gray-400 disabled:cursor-not-allowed font-medium"
      >
        {processing ? 'Processing...' : `Pay $${amount.toFixed(2)}`}
      </button>
      <p className="text-xs text-muted-foreground/60 text-center">Your payment is secure and encrypted by Stripe</p>
    </form>
  )
}
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <button onClick={() => router.push('/')} className="bg-primary text-foreground px-6 py-2 rounded-lg hover:bg-primary/90">Go Home</button>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-primary text-foreground px-6 py-4">
