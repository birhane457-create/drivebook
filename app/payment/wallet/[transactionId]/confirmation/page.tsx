    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <button onClick={() => router.back()} className="bg-primary text-foreground px-6 py-2 rounded-lg hover:bg-primary/90">
            Try Again
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
        ...
        <div className="space-y-3">
          <Link
            ...
            className="block w-full bg-primary text-foreground px-6 py-3 rounded-lg hover:bg-primary/90 font-medium"
          >
            Go to Dashboard →
          </Link>
          <Link
