  ...
  if (!instructor) {
    return (
      <MultiStepBookingLayout currentStep={2}>
        <div className="space-y-6 text-foreground flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-white mb-4"></div>
            <p className="text-foreground/85">Loading package options...</p>
          </div>
        </div>
      ...
      <div className="space-y-6 text-foreground">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-white/15">
          ...
          <button
            ...
            type="button"
            className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 text-foreground px-8 py-4 rounded-lg font-semibold hover:from-purple-500 hover:to-pink-500 transition-colors"
          >
            Continue →
          </button>
        </div>
