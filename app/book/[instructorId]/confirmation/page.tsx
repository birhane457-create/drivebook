        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-gray-300 flex-shrink-0 flex items-center justify-center text-white text-2xl font-bold">
              {(bookingState.instructor.displayName || bookingState.instructor.name).charAt(0)}
            </div>
            <div className="flex-1">
              <p className="font-semibold text-gray-900">{bookingState.instructor.displayName || bookingState.instructor.name}</p>
