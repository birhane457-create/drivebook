...
const STATUS_BADGE: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  APPROVED:  { label: 'Approved',  color: 'text-primary bg-sky-400/10 border-sky-400/30',         icon: <CheckCircle className="w-3 h-3" /> },
  ...
  READY:     { label: 'Ready',     color: 'text-emerald-400 bg-green-400/10 border-green-400/30',   icon: <CheckCircle className="w-3 h-3" /> },
  DELIVERED: { label: 'Delivered', color: 'text-muted-foreground bg-slate-400/10 border-slate-400/30',   icon: <CheckCircle className="w-3 h-3" /> },
  CANCELLED: { label: 'Cancelled', color: 'text-destructive bg-red-400/10 border-red-400/30',         icon: <AlertCircle className="w-3 h-3" /> },
}
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-4">
            ...
            <button
              ...
              className={`flex-1 py-2 text-sm font-semibold rounded-lg border transition-all ${
                side === 'front'
                  ...
                  : 'bg-card border-border text-muted-foreground hover:border-sky-600'
              }`}
            >
              Front
            </button>
          ...
          <button
            ...
            disabled={generating}
            className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-sky-500 disabled:bg-secondary/70 disabled:text-muted-foreground/60 text-foreground font-semibold py-3 rounded-xl transition-all"
          >
            {generating ? (
          ...
          {pdfError && (
            <div className="flex items-center gap-2 text-destructive text-xs font-medium bg-red-950/40 border border-red-900/50 rounded-lg px-3 py-2 -mt-1">
        ...
        <div className="space-y-6">
          ...
          {/* Print request */}
          <div className="bg-card rounded-2xl border border-border p-5">
            <h2 className="text-sm font-bold text-foreground mb-1 uppercase tracking-wide flex items-center gap-2">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-background border border-border text-foreground rounded-lg text-sm focus:ring-2 focus:ring-primary/50"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-background border border-border text-foreground rounded-lg text-sm focus:ring-2 focus:ring-primary/50 resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  disabled={requesting}
                  className="w-full flex items-center justify-center gap-2 bg-secondary/70 hover:bg-slate-600 disabled:opacity-50 text-foreground font-semibold py-2.5 rounded-xl text-sm transition-all"
                >
                  {requesting ? (
