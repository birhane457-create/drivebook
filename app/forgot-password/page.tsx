      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-purple-100 border border-purple-300 mb-4">
            <Mail className="w-7 h-7 text-purple-600" aria-hidden="true" />
          </div>
        ...
        <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl shadow-2xl shadow-purple-900/50 border border-white/20 p-6 sm:p-8 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-secondary border border-white/20 rounded-lg text-foreground placeholder-white/50 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/30 focus:bg-white/15 transition-all backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
          ...
          <div className="mt-6 pt-5 border-t border-border flex items-center justify-between text-sm">
            ...
            <Link href="/register" className="text-gray-600 hover:text-gray-700 transition-colors">
              Create account
            </Link>
          </div>
        </div>
        ...
        <p className="text-center mt-6 text-xs text-foreground/40">
          Need help? Contact{' '}
          <a href="mailto:support@drivebook.com" className="text-foreground/60 hover:text-foreground/80 transition-colors">
