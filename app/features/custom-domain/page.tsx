  ...
  return (
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <main>
        {/* Hero */}
        <FeatureHero
          gradientClasses={heroPresets.blue.gradient}
          badgeIcon={Zap}
          badgeText="Available on PRO and above"
          badgeColors={heroPresets.blue.badgeColors}
          title={
            <>
          ...
          description="Connect your own domain to DriveBook and give your driving school a professional web presence at your own address — like perthdriving.com.au. No website builder. No developer. No maintenance."
          ctaHref="/teach-with-drivebook"
          ctaText="Start Free Trial →"
          ctaGradient={heroPresets.blue.ctaGradient}
          ctaShadow={heroPresets.blue.ctaShadow}
          secondaryLink={{
            href: '/blog/connecting-your-custom-domain-drivebook',
            text: 'Setup Guide'
          }}
          breadcrumb={{
          ...
          blobColor={heroPresets.blue.blobColor}
        />
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 md:py-20">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-4">Your brand. Your domain. DriveBook's engine.</h2>
              <p className="text-foreground/60 leading-relaxed mb-4">
                Every DriveBook instructor already has a booking page at <span className="text-foreground">yourname.drivebook.com.au</span>. That's a good start.
              </p>
              <p className="text-foreground/60 leading-relaxed mb-4">
                With a custom domain, the same professional booking page — with your logo, brand colours, real-time availability, and online booking — lives at <span className="text-foreground">yourownname.com.au</span>.
              </p>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={before} className="bg-white/[0.04] border border-border rounded-2xl p-5">
                  <p className="text-foreground/40 text-xs mb-2">{label}</p>
                  <div className="flex items-center gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-foreground/40 text-xs line-through truncate">{before}</p>
        ...
        <section className="bg-white/[0.02] border-y border-border py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground text-center mb-3">Setup in 3 Steps</h2>
            <p className="text-foreground/50 text-center mb-10 text-sm">Takes under 30 minutes. No technical knowledge required.</p>
        ...
        {/* Benefits */}
        <section className="max-w-4xl mx-auto px-4 py-16 md:py-20">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">Why It Matters</h2>
        ...
        <section className="max-w-4xl mx-auto px-4 pb-12">
          <h2 className="text-3xl font-bold text-foreground mb-3 text-center">Custom Domain vs DriveBook Subdomain vs Social Media</h2>
          <p className="text-foreground/50 text-center text-sm mb-10">Three options — very different results for your brand.</p>
          <div className="overflow-x-auto rounded-2xl border border-border">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-white/[0.04]">
                  <th className="text-left p-4 text-foreground/60 font-semibold">Feature</th>
                  <th className="text-center p-4 text-indigo-400 font-bold">Custom Domain</th>
                  <th className="text-center p-4 text-foreground/60 font-semibold">DriveBook Subdomain</th>
                  <th className="text-center p-4 text-foreground/50 font-semibold">Social Media Page</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  const Cell = ({ val }: { val: boolean | string }) =>
                    ...
                    val === false ? <XCircle className="h-5 w-5 text-destructive/60 mx-auto" /> :
                    <span className="text-yellow-400 text-xs font-semibold">Partial</span>
                  return (
                    <tr key={f} className="border-b border-border/60 hover:bg-white/[0.02]">
                      <td className="p-4 text-foreground/80">{f}</td>
          ...
          <div className="space-y-2">
            {[
              ...
              <Link key={href} href={href} className="flex items-center justify-between p-3.5 rounded-xl border border-border bg-card/40 hover:bg-white/[0.07] hover:border-white/20 transition-all no-underline group">
                ...
                <ChevronRight className="h-4 w-4 text-foreground/30 group-hover:text-indigo-400 shrink-0 ml-3" />
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-16">
          <div className="rounded-2xl bg-gradient-to-br from-indigo-900/60 to-blue-900/60 border border-indigo-500/30 p-10 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-3">Own Your Online Presence</h2>
            <p className="text-foreground/60 mb-6 text-sm max-w-md mx-auto">Custom domain is included in DriveBook PRO. Start your free trial, then connect your domain in under 30 minutes.</p>
            ...
            <p className="text-foreground/30 text-xs mt-4">No credit card required · Full PRO features during trial</p>
          </div>
        </section>
      </main>
      <SiteFooter />
