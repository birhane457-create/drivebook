...
import { Users, BarChart3, CheckCircle, XCircle, ChevronRight, Zap, Calendar, CreditCard, Building } from 'lucide-react'
    ...
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <FeatureHero
          ...
          badgeIcon={Zap}
          badgeText="STUDIO & BUSINESS plans"
          ...
          description="Individual instructor calendars, per-instructor earnings, student assignment, and school-level branding — all visible to the school owner from one admin view."
          ...
          breadcrumb={{
            ...
            current: 'Multi-Instructor Management'
          }}
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 md:py-20">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">What the Admin Dashboard Shows</h2>
        ...
        {/* Plan comparison */}
        <section className="bg-white/[0.02] border-y border-border py-14 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground text-center mb-3">Which Plan Do I Need?</h2>
            <p className="text-foreground/50 text-center text-sm mb-10">Multi-instructor management is available on STUDIO and BUSINESS.</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border bg-white/[0.04]">
                    ...
                    <th className="text-center p-4 text-foreground/50">BASIC / PRO</th>
                ...
                <tbody>
                  {[
                    ...
                    const Cell = ({ v }: { v: boolean }) => v
                      ...
                      : <XCircle className="h-4 w-4 text-foreground/20 mx-auto" />
                    return (
                      <tr key={f} className="border-b border-border/60 hover:bg-white/[0.02]">
                        <td className="p-4 text-foreground/80 text-xs">{f}</td>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-16">
          <div className="rounded-2xl bg-gradient-to-br from-pink-900/60 to-violet-900/60 border border-pink-500/30 p-10 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-3">Ready to Manage Your School Properly?</h2>
            <p className="text-foreground/60 mb-6 text-sm max-w-md mx-auto">Start on STUDIO for 2–6 instructors. Upgrade to BUSINESS when you need unlimited.</p>
