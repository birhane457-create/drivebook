    ...
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <FeatureHero
          ...
          description="Log lesson notes after each session. Track skill development over time. Let students see their own progress. Prepare them precisely for their PDA."
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 md:py-20">
          <h2 className="text-3xl font-bold text-foreground text-center mb-3">How Progress Tracking Works</h2>
          <p className="text-foreground/50 text-center mb-12 text-sm">Three minutes after each lesson. Visible to the student immediately.</p>
        ...
        <section className="bg-white/[0.02] border-y border-border py-14 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-4">Skill areas tracked</h2>
                <p className="text-foreground/60 leading-relaxed mb-6">Progress is tracked across the core competencies assessed in the WA PDA. Each lesson note contributes to the student's running profile.</p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={skill} className="bg-white/[0.04] border border-border rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-foreground font-medium">{skill}</span>
                      <span className="text-xs text-foreground/50">{pct}%</span>
                    </div>
        ...
        {/* Benefits */}
        <section className="max-w-4xl mx-auto px-4 py-16 md:py-20">
          <h2 className="text-3xl font-bold text-foreground text-center mb-10">Why It Matters</h2>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-16">
          <div className="rounded-2xl bg-gradient-to-br from-violet-900/60 to-indigo-900/60 border border-violet-500/30 p-10 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-3">Build Better Students, Faster</h2>
            <p className="text-foreground/60 mb-6 text-sm max-w-md mx-auto">Progress tracking is included on every DriveBook plan.</p>
