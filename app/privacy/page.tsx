      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              DriveBook supports individual learners, independent driving providers, and may support business or driving school accounts. Where applicable, authorised business owners and administrators may access information necessary to manage bookings, instructors and learner services in accordance with this Privacy Policy.
            </p>
          </section>
