    ...
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8">
          ...
          <section id="account" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>Tip:</strong> Upload ALL documents immediately — the sooner you upload, the sooner you're approved!</p>
            </div>
          </section>
          ...
          <section id="profile" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>Pro tip:</strong> Better profile = more bookings. Be detailed about your teaching style!</p>
            </div>
          </section>

          {/* Availability */}
          <section id="availability" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>Taking time off?</strong> Go to "Block Time" and select your vacation/sick dates.</p>
            </div>
          </section>

          {/* Pricing */}
          <section id="pricing" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>How earnings work:</strong></p>
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>Trial:</strong> 14 days free for all tiers (30 days for Business). After trial, you're charged monthly.</p>
            </div>
          </section>

          {/* Bookings */}
          <section id="bookings" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>Important:</strong> To create bookings, you must:</p>
              <ul className="space-y-1 ml-2">
                <li>✅ Be approved by admin (pending approval = no bookings)</li>
                <li>✅ Have an active subscription (trial or paid)</li>
              </ul>
              <p className="text-muted-foreground text-sm mt-3"><strong>Wallet requirement:</strong> Student must have enough wallet balance to confirm. If short, they get emailed to top up within 10 minutes.</p>
            </div>
          </section>

          {/* Payouts */}
          <section id="payouts" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>Important payout details:</strong></p>
              <ul className="space-y-1 ml-2">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>Example:</strong> Lesson on Monday, completed Monday evening. Included in Tuesday payout.</p>
            </div>
          </section>

          {/* Earnings */}
          <section id="earnings" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>What counts:</strong> Completed lessons only (not pending or cancelled)</p>
              <p className="text-muted-foreground text-sm"><strong>When paid:</strong> Every Tuesday automatically to your bank account</p>
              <p className="text-muted-foreground text-sm"><strong>Example:</strong> $100 lesson, Pro tier (12% commission) = You get $88</p>
            </div>
          </section>

          {/* Reviews */}
          <section id="reviews" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>Affects your rating:</strong></p>
              <ul className="space-y-1 ml-2">
          ...
          {/* Offline Bookings */}
          <section id="offline" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>Why record offline?</strong> Tracks your total earnings, helps with taxes, counts toward activity.</p>
            </div>
          </section>
          ...
          <section id="faq" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-4 text-foreground">
              <div>
                ...
                <p className="text-muted-foreground">A: Usually 2-5 business days. Upload documents immediately for faster approval.</p>
              </div>
              <div>
                <p className="font-semibold">Q: When do I get paid?</p>
                <p className="text-muted-foreground">A: Every Tuesday automatically. Money appears in your bank 1-2 days later.</p>
              </div>
              <div>
                <p className="font-semibold">Q: Can I change my hourly rate?</p>
                <p className="text-muted-foreground">A: Yes, anytime. Changes apply to new bookings only.</p>
              </div>
              <div>
                <p className="font-semibold">Q: What if a student doesn't show up?</p>
                <p className="text-muted-foreground">A: Mark as "No-show" — you still get paid.</p>
              </div>
              <div>
                <p className="font-semibold">Q: Can I set package discounts?</p>
                <p className="text-muted-foreground">A: Not per student, but you can offer package rates. Pricing applies to everyone equally.</p>
              </div>
              <div>
                <p className="font-semibold">Q: How do I respond to bad reviews?</p>
                <p className="text-muted-foreground">A: Go to Profile → Reviews → Click review → Add response. Keep it professional!</p>
              </div>
            </div>
          </section>
        ...
        <div className="mt-12 bg-secondary rounded-lg p-8 border border-border">
          ...
          <p className="text-foreground mb-4">Our instructor support team is here for you</p>
          <a 
            href="mailto:instructors@drivebook.com.au"
            className="inline-block bg-emerald-600 hover:bg-emerald-700 text-foreground px-6 py-3 rounded-lg font-medium transition-colors"
          >
