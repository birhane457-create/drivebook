    ...
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <div className="bg-gradient-to-r from-sky-900 to-sky-800 px-6 py-8">
        <div className="max-w-4xl mx-auto">
          <Link href="/help" className="flex items-center gap-2 text-primary hover:text-sky-200 mb-4">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {sections.map(section => (
              <a
                key={section.id}
                href={`#${section.id}`}
                className="bg-card hover:bg-secondary px-4 py-3 rounded-lg border border-border hover:border-border transition-colors"
              >
        ...
        <div className="space-y-8">
          ...
          {/* Create Account */}
          <section id="account" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4">Tip: Add a profile photo and location for better instructor matches.</p>
            </div>
          </section>

          {/* Find Instructor */}
          <section id="find" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>All instructors shown:</strong> Only approved instructors with active subscriptions appear. No filtering by location, price, or specialty available in the app.</p>
              <p className="text-muted-foreground text-sm"><strong>Rating info:</strong> You can see instructor reviews and star rating (1-5 stars). Higher rated instructors usually get more bookings.</p>
            </div>
          </section>

          {/* Book Lesson */}
          <section id="book" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-3"><strong>No instructor approval step.</strong> Once payment confirmed, the lesson is booked. Check instructor's calendar to confirm date/time.</p>
              <p className="text-muted-foreground text-sm"><strong>Important:</strong> You have 10 minutes to complete payment. If you don't pay within 10 minutes, the slot is released.</p>
            </div>
          </section>

          {/* Payment */}
          <section id="payment" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>Time limit:</strong> You have 10 minutes to complete payment. If you don't pay, the slot is released.</p>
              <p className="text-muted-foreground text-sm"><strong>Safe?</strong> Yes — Stripe handles all payment security. We never see your card details.</p>
            </div>
          </section>

          {/* Reschedule */}
          <section id="reschedule" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4">Tip: Reschedule early — instructors have limited availability.</p>
            </div>
          </section>

          {/* History */}
          <section id="history" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4"><strong>Booking status:</strong> Pending, Confirmed, Completed, Cancelled</p>
            </div>
          </section>

          {/* Review */}
          <section id="review" className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="space-y-3 text-foreground">
              ...
              <p className="text-muted-foreground text-sm mt-4">Your honest review helps other students and helps instructors improve!</p>
            </div>
          </section>

          {/* Profile */}
          <section id="profile" className="bg-card rounded-lg p-6 border border-border">
          ...
          {/* FAQ */}
          <section id="faq" className="bg-card rounded-lg p-6 border border-border">
            <h2 className="text-2xl font-bold mb-4">❓ Common Questions</h2>
            <div className="space-y-4 text-foreground">
              <div>
                <p className="font-semibold">Q: How long until the booking is confirmed?</p>
                <p className="text-muted-foreground">A: It's confirmed instantly after payment! No waiting for instructor response.</p>
              </div>
              <div>
                <p className="font-semibold">Q: What if I don't have enough wallet balance?</p>
                <p className="text-muted-foreground">A: The booking is held for 10 minutes. You'll get an email asking you to top up your wallet to confirm.</p>
              </div>
              <div>
                <p className="font-semibold">Q: Can I reschedule after booking?</p>
                <p className="text-muted-foreground">A: Yes, but only if the booking is confirmed (not while awaiting payment).</p>
              </div>
              <div>
                <p className="font-semibold">Q: Can I cancel my booking?</p>
                <p className="text-muted-foreground">A: Yes anytime. If you cancel while awaiting payment, it's free. After confirmation, cancellation policies apply.</p>
              </div>
              <div>
                <p className="font-semibold">Q: How do I pay?</p>
                <p className="text-muted-foreground">A: We use your wallet balance. If short, top up before the 10-minute window expires.</p>
              </div>
            </div>
          </section>

          {/* Troubleshooting */}
          <section id="troubleshoot" className="bg-card rounded-lg p-6 border border-border">
            <h2 className="text-2xl font-bold mb-4">🔧 Troubleshooting</h2>
            <div className="space-y-4 text-foreground">
              <div>
                <p className="font-semibold">Payment failed?</p>
                <p className="text-muted-foreground">Check your card details, expiry, and funds. Try a different card.</p>
              </div>
              <div>
                <p className="font-semibold">Can't log in?</p>
                <p className="text-muted-foreground">Click "Forgot Password" and check your email for reset link.</p>
              </div>
              <div>
                <p className="font-semibold">Didn't receive confirmation email?</p>
                <p className="text-muted-foreground">Check spam folder. Wait 5 minutes or refresh the page.</p>
              </div>
              <div>
                <p className="font-semibold">Instructor not responding?</p>
                <p className="text-muted-foreground">Wait 24 hours. Booking auto-declines and you get refund.</p>
              </div>
            </div>
          </section>
        ...
        <div className="mt-12 bg-secondary rounded-lg p-8 border border-border">
          ...
          <p className="text-foreground mb-4">Our support team is ready to help</p>
          <a 
            href="mailto:support@drivebook.com.au"
            className="inline-block bg-primary hover:bg-primary/90 text-foreground px-6 py-3 rounded-lg font-medium transition-colors"
          >
            Contact Support
          </a>
        </div>
