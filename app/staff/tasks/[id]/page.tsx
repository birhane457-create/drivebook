          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground/60 mt-1">24-character MongoDB ObjectID</p>
                </div>
            ...
            <div className="flex gap-4 pt-6 border-t">
              ...
              <button
                type="submit"
                disabled={creating}
                className="flex-1 px-4 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
              >
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => router.push('/staff/dashboard')}
            className="mt-4 px-4 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90"
          >
            Back to Dashboard
          </button>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="space-y-4">
                {task.notes.length > 0 ? (
                  ...
                  <p className="text-muted-foreground/60 text-center py-8">No notes yet</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-2">
                {task.status === 'OPEN' && (
                  <button
                    ...
                    className="w-full px-4 py-2 bg-indigo-600 text-foreground rounded-lg hover:bg-indigo-700"
                  >
                    Start Working
                  </button>
                )}
                {task.status === 'IN_PROGRESS' && (
                  <>
                    <button
                      ...
                      className="w-full px-4 py-2 bg-amber-600 text-foreground rounded-lg hover:bg-amber-700"
                    >
                      Waiting for Response
                    </button>
                    <button
                      onClick={() => updateTaskStatus('RESOLVED')}
                      className="w-full px-4 py-2 bg-emerald-600 text-foreground rounded-lg hover:bg-green-700"
                    >
                      Mark as Resolved
                    </button>
                  </>
                ...
                {task.status === 'RESOLVED' && (
                  <button
                    ...
                    className="w-full px-4 py-2 bg-gray-600 text-foreground rounded-lg hover:bg-gray-700"
                  >
                    Close Task
                  </button>
                )}
            ...
            {/* Related Links */}
            {(task.bookingId || task.providerId || task.customerId) && (
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-3">
                  {task.bookingId && (
                    <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                      ...
                      <p className="text-xs text-muted-foreground/60 mt-1">ID: {task.bookingId.slice(0, 8)}...</p>
                    </div>
                  )}
                  {task.providerId && (
                    <div className="p-3 bg-purple-50 rounded-lg border border-purple-200">
                      ...
                      <a
                        href={`/admin/instructors/${task.providerId}`}
                      ...
                      <p className="text-xs text-muted-foreground/60 mt-1">ID: {task.providerId.slice(0, 8)}...</p>
                    </div>
                  )}
                  {task.customerId && (
                    <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <a
                        href={`/admin/clients/${task.customerId}`}
                      ...
                      <p className="text-xs text-muted-foreground/60 mt-1">ID: {task.customerId.slice(0, 8)}...</p>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-4 pt-4 border-t">
                  <p className="text-xs text-muted-foreground/60 mb-2">Quick Actions</p>
