...
export default function InstructorTermsPage() {
  return (
    <div className="light min-h-screen bg-white">
      <nav className="bg-white shadow-sm py-4 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/register" className="bg-purple-600 text-foreground px-5 py-2 rounded-lg font-medium hover:bg-purple-700">Sign Up</Link>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 flex gap-12">
        ...
        <aside className="hidden lg:block w-56 shrink-0">
          <div className="sticky top-8 text-sm space-y-1">
            ...
            {[
              ...
              <a key={href} href={href} className="block text-muted-foreground/60 hover:text-purple-600 py-0.5 pl-2 border-l-2 border-transparent hover:border-purple-400 transition-colors">
                {label}
              </a>
            ))}
          </div>
        ...
        <main className="flex-1 min-w-0">
          <div className="mb-10">
            ...
            <p className="text-muted-foreground/60 text-sm">Version 2.0 · Effective: 6 August 2026 · Last Updated: 6 August 2026</p>
          ...
          <div className="space-y-2 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <ul className="list-none pl-6 space-y-2 mb-4">
                ...
                <li>8B.2. DriveBook may introduce additional business management features in future releases, including multiple providers, administrator roles, team management, and separate payment functionality. Where those features are introduced, additional or updated terms may apply. The Instructor will be notified of any material changes before they take effect.</li>
              ...
              <p className="text-xs text-muted-foreground/60 mb-3 italic">Pricing shown is current as at the Effective Date of this Agreement. See clause 11.3 for rate change provisions.</p>
              <ul className="list-none pl-6 space-y-2 mb-4">
              ...
              <ul className="list-none pl-6 space-y-2 mb-4">
                ...
                <li>11.2. An additional new student bonus commission applies to the first booking with each new client (BASIC: 8%, PRO/STUDIO: 10%).</li>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 flex flex-wrap gap-4 text-sm text-muted-foreground/60">
      ...
      <footer className="bg-gray-800 text-foreground py-8 px-4 mt-8 text-center text-sm text-muted-foreground">
