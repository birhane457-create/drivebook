    ...
    <div className="light min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <nav className="flex items-center gap-2 text-xs text-foreground/40 mb-8">
          ...
          <span>/</span>
          <span className="text-foreground/60">DriveBook vs Calendly</span>
        </nav>

        <div className="mb-12">
          <p className="text-sm font-semibold text-violet-400 uppercase tracking-wider mb-3">Comparison</p>
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-5 leading-tight">DriveBook vs Calendly<br />for Driving Instructors</h1>
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-14">
          <div className="bg-white/[0.04] border border-border rounded-2xl p-6">
            <p className="text-xs font-semibold text-foreground/40 uppercase tracking-wider mb-3">Calendly is good for...</p>
            <ul className="space-y-2">
              {['Simple scheduling links', 'Meeting and consultation bookings', 'Calendar integrations (Google, Outlook)', 'Basic free plan'].map((i: any) => (
          ...
          <div className="bg-white/[0.04] border border-border rounded-2xl p-6">
            <p className="text-xs font-semibold text-foreground/40 uppercase tracking-wider mb-3">Calendly doesn't have...</p>
            <ul className="space-y-2">
              {[
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-white/[0.04]">
                ...
                <th className="text-center p-4 text-foreground/50 font-semibold">Calendly</th>
              </tr>
            </thead>
            <tbody>
        ...
        <section className="mb-12 space-y-4">
          <h2 className="text-2xl font-bold text-foreground">The Core Difference</h2>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-violet-900/60 to-indigo-900/60 border border-violet-500/30 p-10 text-center">
          <h2 className="text-2xl font-bold text-foreground mb-3">Built for Driving Instructors</h2>
          <p className="text-foreground/60 mb-6 text-sm max-w-md mx-auto">Not a general scheduling tool adapted for instructors. A platform built specifically for the way driving schools work.</p>
