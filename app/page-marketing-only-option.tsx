// OPTION: Replace app/page.tsx with this for marketing-only homepage
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex gap-2 sm:gap-4">
              ...
              <Link href="/register" className="bg-primary text-foreground px-3 sm:px-4 py-2 rounded-lg hover:bg-primary/90 text-sm sm:text-base">
                For Instructors
              </Link>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        ...
        <div className="text-center mb-12">
          ...
          <Link 
            href="/book"
            className="bg-primary text-foreground px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary/90 inline-block"
          >
        ...
        {/* Instructor CTA */}
        <div className="text-center mb-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 sm:p-12 text-foreground">
