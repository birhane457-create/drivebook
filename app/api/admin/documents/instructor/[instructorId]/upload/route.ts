  ...
  try {
    ...
    if (contentType.includes('application/json')) {
      ...
      if (remove) {
        ...
        await upsertDrivingProfile(params.providerId, { [field]: null } as any);
    ...
    // Dual-write to extension table
    await upsertDrivingProfile(params.providerId, { [field]: result.url } as any);
