...
import { invalidatePricingCache, PackageTier } from '@/lib/config/packages';
import { z } from 'zod';
...
const pricingSchema = z.object({
  ...
  discountPaidBy:             z.enum(['platform', 'shared', 'provider']),
  ...
  packageTiers:               z.array(z.object({
    hours:    z.number().int().min(1).max(50),
