...
export async function POST(
  ...
  try {
    ...
    const deny = await requirePermission(session, PERM.USERS_PROVIDERS_APPROVE);
    if (deny) return deny;
    ...
    // Merge document fields from extension table
      ...
      sendOnboardingStep(
        {
          ...
          voiceLineStatus: (approvedInstructor as any).voiceLineStatus ?? 'NONE',
