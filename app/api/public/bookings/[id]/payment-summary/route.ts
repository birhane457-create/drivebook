...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      provider: {
        name: getDisplayName(booking.provider),
        profileImage: booking.provider.profileImage ?? null,
        rating: booking.provider.averageRating ?? null,
        reviews: booking.provider.totalReviews ?? 0,
      },
