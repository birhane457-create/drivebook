...
export async function GET(req: NextRequest) {
  try {
    ...
    // Merge driving-specific fields from extension table for each instructor
    ...
    const instructorsWithDistance = instructorsWithDriving
      .map((instructor: any) => {
      ...
      .filter((instructor: any) => instructor.isWithinRadius)
      .sort((a: any, b: any) => {
    ...
    return NextResponse.json({
      providers: instructorsWithDistance,
